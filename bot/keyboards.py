        ...
        [
            [
                InlineKeyboardButton(
                    "📊 Price and Vol", callback_data=f"chartselect:price:{clean_symbol}"
                ),
                InlineKeyboardButton(
                    "📈 RSI, MACD, ATR", callback_data=f"chartselect:indicators:{clean_symbol}"
                ),
            ],
            [
...
def stock_result_menu(symbol, has_chart=True):
    ...
    if has_chart:
        buttons.append(
            [
                InlineKeyboardButton(
                    "📊 Price and Vol", callback_data=f"chartselect:price:{symbol}"
                ),
                InlineKeyboardButton(
                    "📈 RSI, MACD, ATR", callback_data=f"chartselect:indicators:{symbol}"
                ),
            ]
        )
